    ...
    <nav className="nav">
      <div className="nav__cntr-1">
        ...
        <ul className="nav__menu">
          <li className="nav__list--project" onClick={handleRedirect}>
            <BiCabinet /> Projects
          </li>
          <li className="nav__list--team">
            <AiOutlineTeam /> Teams
          </li>
          <li className="nav__list--create" onClick={handleClick}>
            <BsFolderPlus /> New Project
          </li>
        </ul>
      </div>
      <div className="nav__cntr-2">
        ...
        <div className="nav__img-div" onClick={handleDropdown}>
          <img
            src={`${url}/${userInfo.profile_pic}` || sample}
            alt={
              `${userInfo.firstname} ${userInfo.lastname}` ||
              "Sample user profile pic"
            }
            className="nav__img"
          />
        </div>
      ...
      {isDropdown && (
        <div className="nav__account">
          <div className="nav__dropdown">
            ...
            <ul className="nav__dropdown-menu">
              <li
                ...
                onClick={handlePersonalSettingsNav}
              >
          ...
          <ul className="nav__section">
            ...
            <li className="nav__section-item" onClick={handleLogout}>
              Log out
            </li>
          </ul>
        </div>
